...
SELECT pg_catalog.setval('main_seq', 10584, true);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (13, 'Transaction configuration issue: AWT classes not selected as entry points', 'L', 'L', 0, NULL, NULL, NULL, 'ERROR', 'Transaction configuration', 'Issue', true);
...
and cob.object_fullname like ''%.SYSIBM%'' order by char_value2 ASC;', NULL, NULL, 'ERROR', 'Boundary definition', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (65005, 'Cost Complexity', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
...
and object_language_name = ''Java'';', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+Batch', NULL, 'ERROR', 'Transaction configuration', 'Issue', true);
...
and cli.called_id = cld.object_id and cld.object_type_str = ''SQL Table'');', NULL, NULL, 'ERROR', 'Boundary definition', 'Issue', true);
...
and setdefinition like ''%javax.xml.rpc%'' order by 1;', NULL, 86, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+liquibase.database', 181, 'INFO', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10322, 'EFP - Deleted Transaction FP', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (2, 'Implementation issue: Server Settings', 'L', 'S', 0, 'SELECT 0 AS NUM_VALUE,0 AS NUM_VALUE2,0 AS NUM_VALUE3, name AS CHAR_VALUE, setting AS CHAR_VALUE2,unit  AS CHAR_VALUE3 FROM pg_settings order by name asc   ;', NULL, NULL, 'INFO', 'Implementation', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.eclipse.birt.report%'' order by 1;', NULL, 115, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%java.security%'' order by 1;', NULL, 40, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.ws.rs%'' order by 1;', NULL, 83, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.sun.grizzly.http.servlet%'' order by 1;', NULL, 66, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Web.Mail%'' order by 1;', NULL, 279, 'INFO', 'Transaction configuration', 'Issue', true);
...
and (select distinct 1 from #SCHEMA_NAME#cdt_objects cob, #SCHEMA_NAME#dss_datafunction ddf where cob.object_id = ddf.maintable_id and cob.object_type_str = ''SQL Table'' and cal_flags not in (8,10,128,136,140, 256, 258, 260))=1;', NULL, NULL, 'ERROR', 'Transaction configuration', 'Issue', true);
...
ORDER BY total_size DESC', NULL, NULL, 'INFO', 'Implementation', 'Advice', true);
...
AND object_fullname LIKE ''%Unknown%'';', NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10302, 'EFP - Added Transaction FP', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10301, 'EFP - Added Data FP', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10204, 'Unadjusted Transactional Functions', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10163, 'Number of Tables', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (60012, 'Changeability', 'N', 'C', 0, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10321, 'EFP - Deleted Data FP', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10155, 'Number of Classes', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (60011, 'Transferability', 'N', 'C', 0, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%java.nio%'' order by 1;', NULL, 39, 'INFO', 'Transaction configuration', 'Issue', true);
...
AND csv1.object_type=''.NET Method'' 
AND csv2.object_type=''.NET Method'' 
AND csv1.parent_type like ''%Class'');', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+Persits.PDF.PdfManager', 272, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.klg.jclass%'' order by 1;', NULL, 64, 'INFO', 'Transaction configuration', 'Issue', true);
...
GROUP BY 1,2,3,4
ORDER BY 4 DESC LIMIT 10;', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%Microsoft.VisualBasic.MyServices%'' order by 1;', NULL, 267, 'INFO', 'Transaction configuration', 'Issue', true);
...
AND LOWER(object_name) like LOWER(''%jar'');', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
AND (object_fullname like ''com.broadridge.%'' or object_fullname like ''com.br.%'' or object_fullname like  ''com.adp.%'');', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
order by 1;', NULL, 33, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.xml.soap%'' order by 1;', NULL, 47, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+java.security', 129, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+java.util.zip', 132, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.commons.io', 138, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.sun.msv', 140, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.ibm.wsc', 150, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.Net%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+System.Net', 210, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.jws.soap%'' order by 1;', NULL, 81, 'INFO', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10151, 'Number of Code Lines', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+sun.net.telnet', 139, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.mail%'' order by 1;', NULL, 46, 'INFO', 'Transaction configuration', 'Issue', true);
...
and csv2.object_type=''.NET Method''));', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
', NULL, 275, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.jws%'' order by 1;', NULL, 80, 'INFO', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (125, 'Transaction Configuration: Use of Public WebServices JAX-WS.  API. Generic Set available.', 'L', 'M', 0, NULL, NULL, 36, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+com.sun.java.swing.plaf.windows', 156, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+com.sun.jersey.api.client', 157, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+com.klg.jclass', 153, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.sshtools.j2ssh', 154, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+freemarker.ext.servlet', 164, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.stream%'' order by 1;', NULL, 48, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.imageio', 168, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.apache.commons.fileupload%'' order by 1;', NULL, 102, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.imageio%'' order by 1;', NULL, 79, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javachart.chart%'' order by 1;', NULL, 78, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javachart.servlet%'' order by 1;', NULL, 77, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.xml.transform.stream', 176, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.axiom.soap', 186, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.camel', 188, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.commons.fileupload', 190, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%net.sf.jxls.reader%'' order by 1;', NULL, 95, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%Amib.Threading.SmartThreadPool%'' order by 1;', NULL, 211, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.cxf.jaxws', 198, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.dom4j.io', 200, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.drools.io', 201, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.ibm.websphere.webservices%'' order by 1;', NULL, 59, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+net.sourceforge.jtds.jdbc', 184, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.ibm.eNetwork%'' order by 1;', NULL, 54, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.ibm.mq', 146, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%net.sf.jasperreports.view%'' order by 1;', NULL, 94, 'INFO', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (5, 'Configuration issue: Orphan Technology on application with multiple technology', 'L', 'L', 0, 'select 0 AS num_value, 0 AS num_value2, 0 as num_value3,caller AS char_value,'''' AS char_value2, '''' AS char_value3
from (
select * from (
...
where (select count(1) from (select object_language_name, count(1) from #SCHEMA_NAME#cdt_objects group by object_language_name having count(1)>1) as request) >1;', NULL, NULL, 'ERROR', 'Analysis configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%liquibase.database%'' order by 1;', NULL, 93, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.commons.net.ftp', 196, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+com.sun.xml.ws.transport.http.servlet', 162, 'INFO', 'Transaction configuration', 'Issue', true);
...
and object_type_str in ( ''CICS Map'', ''CICS Transaction'');', NULL, NULL, 'ERROR', 'Boundary definition', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.apache.commons.net.ftp%'' order by 1;', NULL, 109, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.apache.commons.mail%'' order by 1;', NULL, 108, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.ajaxtags.servlets%'' order by 1;', NULL, 97, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+java.awt', 121, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.commons.compress', 194, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+javachart.servlet', 166, 'INFO', 'Transaction configuration', 'Issue', true);
...
AND csv.object_type_ext='' public''
AND csv.object_type=''Java Method'' 
AND csv.parent_type=''Java Class'');', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%java.io%'' order by 1;', NULL, 37, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.sun.msv%'' order by 1;', NULL, 51, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.sun.xml.ws.transport.http.servlet%'' order by 1;', NULL, 73, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.sun.jndi.toolkit.url%'' order by 1;', NULL, 72, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.sun.jndi.url%'' order by 1;', NULL, 70, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+net.sf.jasperreports.view', 182, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.sun.jersey..client%'' order by 1;', NULL, 68, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.apache.poi%'' order by 1;', NULL, 112, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.ibm.wsc%'' order by 1;', NULL, 61, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.apache.cxf.jaxws%'' order by 1;', NULL, 111, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Windows.Forms.Screen%'' order by 1;', NULL, 221, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+javax.swing', 122, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+java.applet', 123, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%Persits.PDF.PdfManager%'' order by 1;', NULL, 271, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+Java+-+Servlets', 124, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE EXT.IDOBJ = cob.OBJECT_ID
 ...
 AND cob.object_name NOT LIKE ''_jspService''
 AND cob.object_fullname like ''java.io%''
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+java.io', 126, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%Chilkat%'' order by 1;', NULL, 249, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.xml.rpc.handler.soap%'' order by 1;', NULL, 84, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.dom4j.io%'' order by 1;', NULL, 113, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.ejb', 133, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.sun.jndi.ldap%'' order by 1;', NULL, 69, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE EXT.IDOBJ = cob.OBJECT_ID
 ...
 AND cob.object_name NOT LIKE ''_jspService''
 AND cob.object_fullname like ''java.io%''
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+java.nio', 128, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Net%'' order by 1;', NULL, 239, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.jms', 134, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.mail', 135, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.xml.soap', 136, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.stream', 137, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.ibm.jms', 145, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.ibm.msg', 147, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.ibm.ws', 149, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.informix.jdbc', 151, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.itextpdf', 152, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.sun.jndi.ldap', 158, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%freemarker.ext.servlet%'' order by 1;', NULL, 74, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.sun.jndi.url', 159, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.sun.mail.smtp', 160, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.opensaml.xml.io', 206, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javolution.xml.stream%'' order by 1;', NULL, 92, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.apache.commons.compress%'' order by 1;', NULL, 106, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+freemarker.ext.servlet', 163, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+javachart.applet', 165, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.jws.soap', 170, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.print', 171, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE EXT.IDOBJ = cob.OBJECT_ID
 ...
 AND cob.object_name NOT LIKE ''_jspService''
 AND cob.object_fullname like ''javax.xml.soap%''
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.xml.soap', NULL, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.apache.commons.httpclient%'' order by 1;', NULL, 105, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.xml.ws', 177, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.xml.ws', 179, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+net.sf.jxls.reader', 183, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.camel', 189, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.commons.dbutils', 191, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE EXT.IDOBJ = cob.OBJECT_ID
 ...
 AND cob.object_name NOT LIKE ''_jspService''
 AND cob.object_fullname like ''org.apache.commons.io%''
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.commons.io', NULL, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Xml%'' order by 1;', NULL, 247, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%icc.BaseClasses.OrderForm%'' order by 1;', NULL, 223, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.commons.mail', 195, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.apache.commons.exec%'' order by 1;', NULL, 104, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.apache.commons.dbutils%'' order by 1;', NULL, 103, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.Web.Mail%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+System.Web.Mail', 280, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.ws.rs', 172, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.commons.net.telnet', 197, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.jdom.input', 203, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+java.rmi', 142, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.opensaml.xml.io%'' order by 1;', NULL, 119, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Web.Services%'' order by 1;', NULL, 245, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.IO%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/System.IO', 236, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''Microsoft.Reporting.WebForms%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+Microsoft.Reporting.WebForms', 214, 'INFO', 'Transaction configuration', 'Issue', true);
...
', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+System.Web.UI', 220, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%Microsoft.Reporting.WebForms%'' order by 1;', NULL, 213, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%icc.BaseClasses%'' order by 1;', NULL, 283, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.apache.commons.net.telnet%'' order by 1;', NULL, 110, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''Amib.Threading.SmartThreadPool%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+Amib.Threading.SmartThreadPool', 212, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''icc.BaseClasses.OrderForm%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+icc.BaseClasses.OrderForm', 224, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''Persits.PDF.PdfDocument%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+Persits.PDF.PdfDocument', 216, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.Data%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/System.Data', 228, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.Threading%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+System.Threading', 218, 'INFO', 'Transaction configuration', 'Issue', true);
...
and csv2.object_type=''Java Method''));
', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.Messaging%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/System.Messaging', 238, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.Windows.Forms.Screen%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+System.Windows.Forms.Screen', 222, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.Security.Cryptography%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/System.Security.Cryptography', 244, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''icc.BaseClasses.OrderForm%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+skmMenu.Menu', 226, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%java.net%'' order by 1;', NULL, 38, 'INFO', 'Transaction configuration', 'Issue', true);
...
and csv2.object_type=''C# Method''));', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.Xml%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/System.Xml', 248, 'INFO', 'Transaction configuration', 'Issue', true);
...
AND OBJ.object_type_str = ''Cobol Program'';', NULL, NULL, 'INFO', 'Analysis configuration', 'Advice', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Web.UI%'' order by 1;', NULL, 281, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.Diagnostics%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+System.Diagnostics', 276, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.DirectoryServices%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/System.DirectoryServices', 234, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.Uri%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+System.Uri', 278, 'INFO', 'Transaction configuration', 'Issue', true);
...
AND csv.object_type_ext='' public''
AND csv.object_type=''C# Method''
AND csv.parent_type=''C# Class'');', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%java.util.zip%'' order by 1;', NULL, 43, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''Microsoft.Office.Interop.Excel%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Microsoft.Office.Interop.Excel', 230, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.Web.UI%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+System.Web.UI', 282, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Threading%'' order by 1;', NULL, 217, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''icc.BaseClasses%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+icc.BaseClasses', 284, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.Reflection%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/System.Reflection', 242, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
     ...
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;
', 'https://confluence.castsoftware.com/display/PSPS/System.Console', 232, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.ibm.eNetwork', 143, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.informix.jdbc%'' order by 1;', NULL, 62, 'INFO', 'Transaction configuration', 'Issue', true);
...
order by cob.object_name ASC;', NULL, NULL, 'ERROR', 'Analysis configuration', 'Issue', true);
...
order by form_id)
and dt.form_id = objt.object_id
and object_type_str = ''JCL Job'';', NULL, NULL, 'ERROR', 'Boundary definition', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.jdom.output', 204, 'INFO', 'Transaction configuration', 'Issue', true);
...
', NULL, NULL, 'ERROR', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%java.rmi%'' order by 1;', NULL, 53, 'INFO', 'Transaction configuration', 'Issue', true);
...
', NULL, 265, 'INFO', 'Transaction configuration', 'Issue', true);
...
order by 1;', NULL, 34, 'INFO', 'Transaction configuration', 'Issue', true);
...
AND csv.object_type_ext='' public''
AND csv.object_type=''.NET Method'' 
AND csv.parent_type=''VB.NET Class'');', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
WHERE 
object_type_str=''Cobol Program'' 
AND object_fullname LIKE ''%Unknown%'' AND ( object_name LIKE ''&%'' OR object_name LIKE ''$%'' OR object_name LIKE ''\%%'');', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
FROM #SCHEMA_NAME#cdt_objects cdt, #SCHEMA_NAME#ctv_links ctv
WHERE ctv.called_id=cdt.object_id
AND cdt.object_type_str=''Cobol Program'' );', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.Web.Services%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/System.Web.Services', 246, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''Ionic%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+Ionic', 252, 'INFO', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10154, 'Number of Files', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''NewRiver%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+NewRiver', 270, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%Microsoft.Security.Application%'' order by 1;', NULL, 255, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javachart.applet%'' order by 1;', NULL, 76, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.DirectoryServices%'' order by 1;', NULL, 233, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''Microsoft.Practices.EnterpriseLibrary%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+Microsoft.Practices.EnterpriseLibrary', 254, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''Microsoft.SqlServer.Server%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+Microsoft.SqlServer.Server', 258, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
     ...
     AND EXT.Prop = 1
ORDER BY object_fullname ASC;', NULL, NULL, 'INFO', 'Analysis configuration', 'Advice', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.IO%'' order by 1;', NULL, 235, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE object_type_str=''eDirectory'' 
AND LOWER(object_name) like LOWER(''%jar'');', NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (60016, 'Security', 'N', 'C', 0, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (60015, 'SEI Maintainability', 'N', 'C', 0, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10203, 'Unadjusted Data Functions', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (287, 'Transaction information', 'L', 'L', 0, 'select tb_all_tr.tr_count as num_value, tb_empty_tr.tr_count as num_value2, 0 as num_value3, null as char_value, null as char_value2, null as char_value3 
		...
		where tb_all_tr.const = tb_empty_tr.const;', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.enterprisedt.net.ftp', 141, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.xml.ws.handler.soap%'' order by 1;', NULL, 91, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.xml.ws.soap%'' order by 1;', NULL, 90, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.xml.ws%'' order by 1;', NULL, 89, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.xml.transform.stream%'' order by 1;', NULL, 88, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''Microsoft.VisualBasic.FileSystem%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+Microsoft.VisualBasic.FileSystem', 266, 'INFO', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (60013, 'Robustness', 'N', 'C', 0, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (60014, 'Performance', 'N', 'C', 0, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Web.UI%'' order by 1;', NULL, 219, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.apache.camel.component.jpa%'' order by 1;', NULL, 101, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.apache.camel.component.jms%'' order by 1;', NULL, 100, 'INFO', 'Transaction configuration', 'Issue', true);
...
order by 1;', NULL, 120, 'INFO', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10156, 'Number of Programs', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+org.ajaxtags.servlets', 185, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.apache.camel.component.file%'' order by 1;', NULL, 99, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.apache.axiom.soap%'' order by 1;', NULL, 98, 'INFO', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10312, 'EFP - Modified Transaction FP', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (60017, 'Technical Quality Index', 'N', 'C', 0, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.jdom.output%'' order by 1;', NULL, 117, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%freemarker.template%'' order by 1;', NULL, 75, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Uri%'' order by 1;', NULL, 277, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.sshtools.j2ssh%'' order by 1;', NULL, 65, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+JAX-WS+-+WebServices', 125, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%net.sourceforge.jtds.jdbc%'' order by 1;', NULL, 96, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%Microsoft.SqlServer.Server%'' order by 1;', NULL, 257, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
     ...
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;
', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+Chilkat', 250, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Console%'' order by 1;', NULL, 231, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.Net%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/System.Net', 240, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+sun.swing', 207, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.ibm.msg%'' order by 1;', NULL, 58, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.ibm.edms%'' order by 1;', NULL, 55, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+com.sun.grizzly.http.servlet', 155, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.sun.jndi.toolkit.url', 161, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.ibm.mq%'' order by 1;', NULL, 57, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.apache.commons.io%'' order by 1;', NULL, 49, 'INFO', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (12, 'Transaction configuration issue: main methods not selected as entry points', 'L', 'L', 0, NULL, NULL, NULL, 'ERROR', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.jws.soap', 169, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.commons.httpclient', 193, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.jms%'' order by 1;', NULL, 45, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.jdom2.output', 205, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.itextpdf%'' order by 1;', NULL, 63, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%Microsoft.Office.Interop.Excel%'' order by 1;', NULL, 229, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.sun.mail.smtp%'' order by 1;', NULL, 71, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%java.sql%'' order by 1;', NULL, 41, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.jdom.input%'' order by 1;', NULL, 116, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.drools.io%'' order by 1;', NULL, 114, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+javachart.chart', 167, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.sun.java.swing.plaf.windows%'' order by 1;', NULL, 67, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.xml.stream%'' order by 1;', NULL, 87, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.xml.rpc.handler.soap', 173, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.ibm.jms%'' order by 1;', NULL, 56, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.xml.rpc.handler.soap', 174, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+Javax.xml.stream', 175, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javax.xml.ws', 178, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+javolution.xml.stream', 180, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.poi', 199, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+org.eclipse.birt.report', 202, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.print%'' order by 1;', NULL, 82, 'INFO', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (15, 'Configuration issue: struts configuration are not analyzed', 'L', 'L', 0, NULL, NULL, NULL, 'ERROR', 'Analysis configuration', 'Issue', true);
...
WHERE EXT.IDOBJ = cob.OBJECT_ID
 ...
 AND cob.object_name NOT LIKE ''_jspService''
 AND cob.object_fullname like ''java.io%''
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+java.net', 127, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Messaging%'' order by 1;', NULL, 237, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.camel', 187, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
     ...
     AND OBJ.object_type_str = ''.Net class''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', NULL, NULL, 'INFO', 'Analysis configuration', 'Advice', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%java.util.queue%'' order by 1;', NULL, 42, 'INFO', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10158, 'Number of SQL Artifacts', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%NewRiver%'' order by 1;', NULL, 269, 'INFO', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10311, 'EFP - Modified Data FP', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+org.apache.commons.exec', 192, 'INFO', 'Transaction configuration', 'Issue', true);
...
order by 1;
', NULL, 32, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.enterprisedt.net.ftp%'' order by 1;', NULL, 52, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.ibm.edms', 144, 'INFO', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10506, 'Number of Decision Points', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (10152, 'Number of Artifacts', 'N', 'C', 1, NULL, NULL, NULL, 'INFO', NULL, 'Advice', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+com.ibm.websphere.webservices', 148, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+java.sql', 130, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Net%'' order by 1;', NULL, 209, 'INFO', 'Transaction configuration', 'Issue', true);
...
FROM 
        pg_tablespace 
) as req where CHAR_VALUE like ''C:/%'';', NULL, NULL, 'ERROR', 'Implementation', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%sun.net.telnet%'' order by 1;', NULL, 50, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%javax.ejb%'' order by 1;', NULL, 44, 'INFO', 'Transaction configuration', 'Issue', true);
...
ORDER BY object_fullname ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+java.util.queue', 131, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%Ionic%'' order by 1;', NULL, 251, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Reflection%'' order by 1;', NULL, 241, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
     ...
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;
', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+Microsoft.VisualBasic.MyServices', 268, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%Microsoft.VisualBasic.FileIO%'' order by 1;', NULL, 263, 'INFO', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (8, 'Configuration issue: Component which doesn''t call anybody', 'L', 'L', 0, 'select count(1) as num_value, 0 as num_value2, 0 as num_value3, clr.object_id as char_value, clr.object_name as char_value2, '''' as char_value3 
from #SCHEMA_NAME#ctv_links cli, #SCHEMA_NAME#cdt_objects clr
where cli.caller_id = clr.object_id
group by clr.object_id, clr.object_name
having count(1) < 1
order by num_value DESC;', NULL, NULL, 'ERROR', 'Analysis configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%org.jdom2.output%'' order by 1;', NULL, 118, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%Persits.PDF.PdfDocument%'' order by 1;', NULL, 215, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%Microsoft.Practices.EnterpriseLibrary%'' order by 1;', NULL, 253, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Data%'' order by 1;', NULL, 227, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''Microsoft.VisualBasic.ApplicationServices%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+Microsoft.VisualBasic.ApplicationServices', 260, 'INFO', 'Transaction configuration', 'Issue', true);
...
having count(1) > 100
order by num_value DESC;', NULL, NULL, 'ERROR', 'Analysis configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (11, 'Transaction configuration issue: Swing classes not selected as entry points', 'L', 'L', 0, NULL, NULL, NULL, 'ERROR', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''Microsoft.Security.Application%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+Microsoft.Security.Application', 256, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%Microsoft.VisualBasic.Devices%'' order by 1;', NULL, 261, 'INFO', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (14, 'Configuration issue: .jasper files are not analyzed', 'L', 'L', 0, NULL, NULL, NULL, 'ERROR', 'Analysis configuration', 'Issue', true);
...
order by char_value2 ASC;', NULL, NULL, 'RECOMMENDATION', 'Transaction configuration', 'Issue', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (4, 'Transaction configuration: Empty Transaction', 'L', 'L', 0, 'select count(1) AS num_value, 0 AS num_value2,0 as num_value3,'''' AS char_value,'''' AS char_value2, '''' AS char_value3
from (
...
and dtr.cal_flags not in (  8, 10, 126, 128,136, 138, 256, 258 ) -- transaction standalone or Root
and DTR.tf_ex=0
order by 9 ASC, 2 ASC) as result;', NULL, NULL, 'WARNING', 'Transaction configuration', 'Issue', true);
...
and object_id not in (select form_id from #SCHEMA_NAME#dss_transaction) 
and object_language_name = ''Java'';', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+Entry+Point+-+Threads', NULL, 'ERROR', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%com.ibm.ws.webservices.engine%'' order by 1;', NULL, 60, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%Microsoft.VisualBasic.ApplicationServices%'' order by 1;', NULL, 259, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Configuration%'' order by 1;', NULL, 273, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%skmMenu.Menu%'' order by 1;', NULL, 225, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''Microsoft.VisualBasic.Devices%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+Microsoft.VisualBasic.Devices', 262, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''System.Configuration%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+System.Configuration', 274, 'INFO', 'Transaction configuration', 'Issue', true);
...
and osd.settype = ''Generic sets''
and sa.attributenumvalue > 0
and setdefinition like ''%System.Security.Cryptography%'' order by 1;', NULL, 243, 'INFO', 'Transaction configuration', 'Issue', true);
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
	 ...
	 AND OBJ.object_fullname like ''Microsoft.VisualBasic.FileIO%''
     AND EXT.Prop = 1) query
ORDER BY query.char_value ASC;', 'https://confluence.castsoftware.com/display/PSPS/Transaction+Configuration+Setup+-+End+Point+-+Microsoft.VisualBasic.FileIO', 264, 'INFO', 'Transaction configuration', 'Issue', true);
...
INSERT INTO servers (server_id, server_name, connection_string, active, last_computed) VALUES (3, 'gaicvmcss7', 'hostaddr=192.168.21.17 port=2280 dbname=postgres user=operator password=CastAIP', false, NULL);
INSERT INTO servers (server_id, server_name, connection_string, active, last_computed) VALUES (4, 'gaicvmcss5', 'hostaddr=192.168.21.48 port=2280 dbname=postgres user=operator password=CastAIP', false, NULL);
...
INSERT INTO servers (server_id, server_name, connection_string, active, last_computed) VALUES (5, '192.168.53.151', 'hostaddr=192.168.53.151 port=2280 dbname=postgres user=operator password=CastAIP', false, NULL);
...
INSERT INTO servers (server_id, server_name, connection_string, active, last_computed) VALUES (9, 'jgdlap', 'hostaddr=192.168.53.80 port=2280 dbname=postgres user=operator password=CastAIP', true, '2016-08-03 15:50:15.65');
