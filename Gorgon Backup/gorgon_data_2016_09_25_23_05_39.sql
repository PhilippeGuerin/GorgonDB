...
SELECT pg_catalog.setval('main_seq', 11889, true);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (315, '# SQL Update', 'L', 'M', 0, 'select DISTINCT object_id as num_value, COUNT (1) as num_value2, 0 as num_value3, 0 as char_value, 0 as char_value2, 0  as char_value3  
    from #SCHEMA_NAME#cms_tool_kbupdate_sqlmode mod group by object_id;', NULL, NULL, 'INFO', NULL, 'Advice', false);
...
INSERT INTO servers (server_id, server_name, connection_string, active, last_computed) VALUES (5, '192.168.53.151', 'hostaddr=192.168.53.151 port=2280 dbname=postgres user=operator password=CastAIP', false, '2016-09-26 00:59:47.637');
...
INSERT INTO servers (server_id, server_name, connection_string, active, last_computed) VALUES (10, '192.168.0.107', 'hostaddr=192.168.0.107 port=2280 dbname=postgres user=operator password=CastAIP', true, '2016-09-26 02:36:54.219');
