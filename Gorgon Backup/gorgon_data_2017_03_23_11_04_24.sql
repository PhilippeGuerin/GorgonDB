...
SELECT pg_catalog.setval('main_seq', 56329, true);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000002, 'Analysis Configuration: You should use the Extension Spring MVC', 'L', 'L', 0, 'select DISTINCT extensions.nbr as num_value, 0 as num_value2, 0 as num_value3, ''You should install the Extension for Spring MVC'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''Java Package'' and object_fullname like ''org.springframework.web.bind.annotation.%'') as checkTable, 
(select count(1) nbr from #SCHEMA_NAME#sys_package_version where package_name like ''/com.castsoftware.springmvc'') extensions where isExist >0  
group by char_value,num_value  having extensions.nbr <1;', NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000020, 'Analysis Configuration: Be sure to select the option yes for hibernate', 'L', 'L', 0, 'select DISTINCT 0 as num_value, 0 as num_value2, 0 as num_value3, ''Be sure to select the option hibernate'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''Java Package'' and (object_fullname like ''org.hibernate.%'' )) as checkTable where isExist >0;', NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000021, 'Analysis Configuration: Be sure to select the option yes for spring', 'L', 'L', 0, 'select DISTINCT 0 as num_value, 0 as num_value2, 0 as num_value3, ''Be sure to select the option Spring'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''Java Package'' and (object_fullname like ''org.springframework.%'' )) as checkTable where isExist >0;', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (365, 'xxxx', 'L', 'M', 0, NULL, NULL, NULL, 'INFO', NULL, 'Advice', false);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (364, 'cms_tool_varcont', 'L', 'M', 0, 'select object_id as num_value, 0 as num_value2, 0 as num_value3, null as char_value, null as char_value2, null as char_value3  
    from #SCHEMA_NAME#cms_tool_varcont;', NULL, NULL, 'INFO', NULL, 'Advice', false);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000006, 'Analysis Configuration: You should use the Extension for WPF or Silverlight', 'L', 'L', 0, 'select DISTINCT extensions.nbr as num_value, 0 as num_value2, 0 as num_value3, ''You should install the Extension for WPF or silverlight'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''.NET Source File'' and lower(object_fullname) like ''%.xaml%'') as checkTable, 
(select count(1) nbr from #SCHEMA_NAME#sys_package_version where package_name like ''/com.castsoftware.wpf'' or package_name like ''/com.castsoftware.silverlight'') extensions where isExist >0  
group by char_value,num_value  having extensions.nbr <1;', NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (355, 'cms_dynamicfields_text', 'L', 'M', 0, 'select object_id as num_value, 0 as num_value2, 0 as num_value3, entity_guid as char_value, field_guid as char_value2, field_value as char_value3  
    from #SCHEMA_NAME#cms_dynamicfields_text;', NULL, NULL, 'INFO', NULL, 'Advice', false);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (361, 'cms_tool_rfpattern', 'L', 'M', 0, 'select object_id as num_value, refdef_id as num_value2, 0 as num_value3, object_name as char_value, null as char_value2, null as char_value3  
    from #SCHEMA_NAME#cms_tool_rfpattern;', NULL, NULL, 'INFO', NULL, 'Advice', false);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000009, 'Analysis Configuration: Be sure to deploy Custom Environment Profile for TestNG', 'L', 'L', 0, 'select DISTINCT 0 as num_value, 0 as num_value2, 0 as num_value3, ''Be sure to deploy Custom Environment Profile for TestNG'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''Java Package'' and lower(object_fullname) like ''org.testng.annotations.%'') as checkTable where isExist >0;', NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000010, 'Analysis Configuration: Be sure to deploy Custom Environment Profile for Mockito', 'L', 'L', 0, 'select DISTINCT 0 as num_value, 0 as num_value2, 0 as num_value3, ''Be sure to deploy Custom Environment Profile for Mockito'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''Java Package'' and lower(object_fullname) like ''org.mockito.%'') as checkTable where isExist >0;', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000001, 'Analysis Configuration: You should use the Extension JAX RS', 'L', 'L', 0, 'select DISTINCT extensions.nbr as num_value, 0 as num_value2, 0 as num_value3, ''You should install the Extension for JAX RS'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''Java Package'' and object_fullname like ''javax.ws.rs.%'') as checkTable, 
(select count(1) nbr from #SCHEMA_NAME#sys_package_version where package_name like ''/com.castsoftware.jaxrs'') extensions where isExist >0  
group by char_value,num_value  having extensions.nbr <1;', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000003, 'Analysis Configuration: You should use the Extension for iBatis and Mybatis', 'L', 'L', 0, 'select DISTINCT extensions.nbr as num_value, 0 as num_value2, 0 as num_value3, ''You should install the Extension for iBatis and Mybatis'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''Java Package'' and object_fullname like ''com.ibatis.%'') as checkTable, 
(select count(1) nbr from #SCHEMA_NAME#sys_package_version where package_name like ''/com.castsoftware.uc.ibatis'') extensions where isExist >0  
group by char_value,num_value  having extensions.nbr <1;', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000005, 'Analysis Configuration: You should use the Extension for Entity Framework', 'L', 'L', 0, 'select DISTINCT extensions.nbr as num_value, 0 as num_value2, 0 as num_value3, ''You should install the Extension for Entity Framework'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''.NET Source File'' and lower(object_fullname) like ''%.edmx%'') as checkTable, 
(select count(1) nbr from #SCHEMA_NAME#sys_package_version where package_name like ''/com.castsoftware.entity'') extensions where isExist >0  
group by char_value,num_value  having extensions.nbr <1;', NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000004, 'Analysis Configuration: You should use the Extension for HTML5', 'L', 'L', 0, 'select DISTINCT extensions.nbr as num_value, 0 as num_value2, 0 as num_value3, ''You should install the Extension for HTML5'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''File which contains source code'' and object_fullname like ''%.html%'') as checkTable, 
(select count(1) nbr from #SCHEMA_NAME#sys_package_version where package_name like ''/com.castsoftware.html5'') extensions where isExist >0  
group by char_value,num_value  having extensions.nbr <1;', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (360, 'cms_tool_progbefore', 'L', 'M', 0, 'select object_id as num_value, varcontainer_id as num_value2, 0 as num_value3, object_name as char_value, progname as char_value2, null as char_value3  
    from #SCHEMA_NAME#cms_tool_progbefore;', NULL, NULL, 'INFO', NULL, 'Advice', false);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (358, 'cms_tool_kbupdate_sqlmode', 'L', 'M', 0, 'select object_id as num_value, 0 as num_value2, 0 as num_value3, null as char_value, null as char_value2, null as char_value3  
    from #SCHEMA_NAME#cms_tool_kbupdate_sqlmode;', NULL, NULL, 'INFO', NULL, 'Advice', false);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (357, 'cms_tool_kbupdate_externalmode', 'L', 'M', 0, 'select object_id as num_value, 0 as num_value2, 0 as num_value3, progname as char_value, null as char_value2, null as char_value3  
    from #SCHEMA_NAME#cms_tool_kbupdate_externalmode;', NULL, NULL, 'INFO', NULL, 'Advice', false);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (363, 'cms_tool_sqlbefore', 'L', 'M', 0, 'select object_id as num_value, varcontainer_id as num_value2, 0 as num_value3, object_name as char_value, null as char_value2, null as char_value3  
    from #SCHEMA_NAME#cms_tool_sqlbefore;', NULL, NULL, 'INFO', NULL, 'Advice', false);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (359, 'cms_tool_progafter', 'L', 'M', 0, 'select object_id as num_value, varcontainer_id as num_value2, 0 as num_value3, object_name as char_value, progname as char_value2, null as char_value3  
    from #SCHEMA_NAME#cms_tool_progafter;', NULL, NULL, 'INFO', NULL, 'Advice', false);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (362, 'cms_tool_sqlafter', 'L', 'M', 0, 'select object_id as num_value, varcontainer_id as num_value2, 0 as num_value3, object_name as char_value, null as char_value2, null as char_value3  
    from #SCHEMA_NAME#cms_tool_sqlafter;', NULL, NULL, 'INFO', NULL, 'Advice', false);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (356, 'cms_tool_kbupdate', 'L', 'M', 0, 'select object_id as num_value, varcontainer_id as num_value2, 0 as num_value3, object_name as char_value, null as char_value2, null as char_value3  
    from #SCHEMA_NAME#cms_tool_kbupdate;', NULL, NULL, 'INFO', NULL, 'Advice', false);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (354, 'cms_tool_sqlmodule', 'L', 'M', 0, 'select object_id as num_value, 0  as num_value2, 0  as num_value3, object_name as char_value, null as char_value2, null as char_value3  
    from #SCHEMA_NAME#cms_tool_sqlmodule;', NULL, NULL, 'INFO', NULL, 'Advice', false);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (353, 'cms_tool_variable', 'L', 'M', 0, 'select object_id as num_value, 0  as num_value2, 0  as num_value3, var_name as char_value, var_value as char_value2, var_desc as char_value3  
    from #SCHEMA_NAME#cms_tool_variable;', NULL, NULL, 'INFO', NULL, 'Advice', false);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000007, 'Analysis Configuration: You should check the version of the hibernate', 'L', 'L', 0, 'select DISTINCT 0 as num_value, 0 as num_value2, 0 as num_value3, ''Be sure to select the right Hibernate version'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''File which contains source code'' and lower(object_fullname) like ''%hbm.xml%'') as checkTable where isExist >0;', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000008, 'Analysis Configuration: Be sure to deploy Custom Environment Profile for XStream', 'L', 'L', 0, 'select DISTINCT 0 as num_value, 0 as num_value2, 0 as num_value3, ''Be sure to deploy Custom Environment Profile for XStream'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''Java Package'' and lower(object_fullname) like ''com.thoughtworks.xstream.annotations.%'') as checkTable where isExist >0;', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000013, 'Analysis Configuration: Be sure to deploy Custom Environment Profile for JBoss Seam', 'L', 'L', 0, 'select DISTINCT 0 as num_value, 0 as num_value2, 0 as num_value3, ''Be sure to deploy Custom Environment Profile for JBoss Seam'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''Java Package'' and lower(object_fullname) like ''org.jboss.seam.log.%'') as checkTable where isExist >0;', NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000015, 'Analysis Configuration: Be sure to deploy Custom Environment Profile for JEE bean Validator (JSR 303)', 'L', 'L', 0, 'select DISTINCT 0 as num_value, 0 as num_value2, 0 as num_value3, ''Be sure to deploy Custom Environment Profile for JEE bean Validator (JSR 303)'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''Java Package'' and (object_fullname like ''javax.validation.%'' or object_fullname like ''org.hibernate.validator.%'')) as checkTable where isExist >0;', NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000016, 'Analysis Configuration: Be sure to deploy Custom Environment Profile for EasyMock', 'L', 'L', 0, 'select DISTINCT 0 as num_value, 0 as num_value2, 0 as num_value3, ''Be sure to deploy Custom Environment Profile for EasyMock'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''Java Package'' and (object_fullname like ''org.easymock.%'' )) as checkTable where isExist >0;', NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000017, 'Analysis Configuration: Be sure to deploy Custom Environment Profile for SLF4J', 'L', 'L', 0, 'select DISTINCT 0 as num_value, 0 as num_value2, 0 as num_value3, ''Be sure to deploy Custom Environment Profile for  SLF4J'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''Java Package'' and (object_fullname like ''org.slf4j.%'' )) as checkTable where isExist >0;', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000000, 'List of annotation', 'L', 'L', 0, 'select DISTINCT object_id as num_value, 0 as num_value2, 0 as num_value3, object_name as char_value, object_fullname as char_value2, object_type_str as char_value3 
FROM #SCHEMA_NAME#cdt_objects OBJ
WHERE OBJ.object_type_str in (''Java Annotation Type Method'', ''Java Annotation Type Method'', ''Java Annotation Type'');', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (352, 'Information: dotnet Package used', 'L', 'L', 0, 'select DISTINCT object_id as num_value, 0 as num_value2, 0 as num_value3, object_fullname as char_value, object_type_str as char_value2, object_language_name as char_value3 
FROM #SCHEMA_NAME#cdt_objects OBJ, #SCHEMA_NAME#OBJPRO EXT
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
     AND  OBJ.object_language_name = ''.NET''
     AND OBJ.object_type_str like ''%.NET Class''
...
WHERE  EXT.IDOBJ = OBJ.OBJECT_ID
     ...
     AND EXT.Prop = 1
ORDER BY object_fullname ASC;', NULL, NULL, 'INFO', 'Analysis configuration', 'Advice', false);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000011, 'Analysis Configuration: Be sure to deploy Custom Environment Profile for JUnit', 'L', 'L', 0, 'select DISTINCT 0 as num_value, 0 as num_value2, 0 as num_value3, ''Be sure to deploy Custom Environment Profile for JUnit'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''Java Package'' and lower(object_fullname) like ''org.junit.%'') as checkTable where isExist >0;', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
AND csv2.object_type=''.NET Method'' 
AND csv1.parent_type like ''%Class'');', NULL, NULL, 'INFO', NULL, 'Advice', false);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000012, 'Analysis Configuration: Be sure to deploy Custom Environment Profile for JSE org.w3c.dom', 'L', 'L', 0, 'select DISTINCT 0 as num_value, 0 as num_value2, 0 as num_value3, ''Be sure to deploy Custom Environment Profile for JSE org.w3c.dom'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''Java Package'' and lower(object_fullname) like ''org.w3c.dom.%'') as checkTable where isExist >0;', NULL, NULL, 'INFO', NULL, 'Advice', true);
INSERT INTO metrics (metric_id, metric_name, metric_type, metric_scope, metric_value_index, list_sql, description, fixing_metric_id, level, category, mode, active) VALUES (1000014, 'Analysis Configuration: Be sure to deploy Custom Environment Profile for JAXB', 'L', 'L', 0, 'select DISTINCT 0 as num_value, 0 as num_value2, 0 as num_value3, ''Be sure to deploy Custom Environment Profile for JAXB'' as char_value, null as char_value2, null as char_value3 
from (select count(1) isExist from #SCHEMA_NAME#cdt_objects where object_type_str = ''Java Package'' and lower(object_fullname) like ''javax.xml.bind.annotation.%'') as checkTable where isExist >0;', NULL, NULL, 'INFO', NULL, 'Advice', true);
...
INSERT INTO servers (server_id, server_name, connection_string, active, last_computed) VALUES (11, '3-lab-mainframe', 'hostaddr=192.168.53.151 port=2280 dbname=postgres user=operator password=CastAIP', true, '2017-03-22 22:58:27.346');
INSERT INTO servers (server_id, server_name, connection_string, active, last_computed) VALUES